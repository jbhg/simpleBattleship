...
public class Submarine extends Ship {
    ...
    public Submarine(Board board, int x_start, int y_start, int x_end, int y_end, int initialstatus) {
        super(board, 3, x_start, y_start, x_end, y_end, initialstatus, "Submarine");
    }
